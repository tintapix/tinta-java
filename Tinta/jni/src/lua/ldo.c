...
int luaD_rawrunprotected (lua_State *L, Pfunc f, void *ud) {
  ...
  L->errorJmp = &lj;
  //printf("TINTA luaL_loadbufferx step 1_3_1 ");
  LUAI_TRY(L, &lj,
    (*f)(L, ud);
  );
  //printf("TINTA luaL_loadbufferx step 1_3_2 ");
...
int luaD_pcall (lua_State *L, Pfunc func, void *u,
  ...
  //printf("TINTA luaL_loadbufferx step 1_4 ");
...
int luaD_protectedparser (lua_State *L, ZIO *z, const char *name,
  ...
  //printf("TINTA luaL_loadbufferx step 1_3 ");
